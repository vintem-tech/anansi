...
# Placing important files

## Application folder and important files
mkdir -p application
...
# docker-compose -f /home/ec2-user/application/docker-compose.yml down
# docker image prune -af
# docker-compose -f /home/ec2-user/application/docker-compose.yml up #-d
...
## Linux service, in order to start app when server starts
echo "[Unit]
Description=run_app
...
" > /usr/lib/systemd/system/run_app.service 
